...
let datos = [
    ...
    Platillo(nombre: "platillo1", ingredientes:2, esPicante: true),
    Platillo(nombre: "platillo2", ingredientes:2, esPicante: true),
    Platillo(nombre: "platillo3", ingredientes:2, esPicante: true)
]
